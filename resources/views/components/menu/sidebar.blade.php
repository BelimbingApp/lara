...
<aside class="shrink-0 w-64 bg-arid-surface dark:bg-zinc-950 h-full flex flex-col border-r border-arid-taupe/40 dark:border-zinc-800">
    ...
    <div class="px-2 py-1 border-t border-arid-taupe/40 dark:border-zinc-800 space-y-0">
        <a href="{{ route('profile.edit') }}" class="flex items-center gap-2 w-full px-2 py-0.5 rounded-none text-sm transition text-arid-ink dark:text-zinc-300 font-normal hover:bg-arid-taupe/30 dark:hover:bg-zinc-800/70">
            <div class="w-7 h-7 rounded-full bg-arid-brown dark:bg-zinc-600 text-arid-cream dark:text-white flex items-center justify-center text-xs font-medium shrink-0">
                {{ auth()->user()->initials() }}
            </div>
