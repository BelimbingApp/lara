...
?>
<div>
    <x-slot name="title">{{ __('Browse') }}</x-slot>

    <div class="space-y-section-gap">
        <x-ui.page-header :title="__('Browse AI Providers')" :subtitle="__('Browse available LLM providers and connect the ones you need.')">
            <x-slot name="help">
                <div class="space-y-3">
                    ...
                    <div>
                        ...
                        <ul class="list-disc list-inside space-y-1 text-muted mt-1">
                            ...
                            <li>{{ __('Click "Connect" on the provider you want to set up.') }}</li>
                            <li>{{ __('On the next page you\'ll enter your API key (or log in for GitHub Copilot).') }}</li>
                        </ul>
                    </div>
                </div>
            </x-slot>
